...
func migrateCmd(appCodec codec.Codec) *cobra.Command {
	return &cobra.Command{
		Use: "migrate",
		Short: `The Migrate command only applies to modify the genesis data exported by version of FURYHub V1.4.1. On this basis, 
...
When FURYHub successfully upgrade to version 2.0, the command will be deleted.
`,
