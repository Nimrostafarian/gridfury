...
func mergeGenesisCmd(encodingConfig params.EncodingConfig) *cobra.Command {
	...
	cmd.Flags().String(testnetFile, "", "gridfury testnet genesis")
	cmd.Flags().String(mainnetFile, "", "gridfury mainnet genesis")
...
var filterAddrs = map[string]bool{
	//distribution
	"did:grid:iaa1jv65s3grqf6v6jl3dp4t6c9t9rk99cd8jaydtw": true,
	//not_bonded_tokens_pool
	"did:grid:iaa1tygms3xhhs3yv487phx3dw4a95jn7t7l5e40dj": true,
	//bonded_tokens_pool
	"did:grid:iaa1fl48vsnmsdzcv85q5d2q4z5ajdha8yu3qef7mx": true,
}
