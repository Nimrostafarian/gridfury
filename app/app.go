...
import (
	...
	"github.com/nimrostafarian/gridfury/address"
	gridfuryante "github.com/nimrostafarian/gridfury/ante"
	gridappparams "github.com/nimrostafarian/gridfury/app/params"
	"github.com/nimrostafarian/gridfury/lite"
	gridevm "github.com/nimrostafarian/gridfury/modules/evm"
	"github.com/nimrostafarian/gridfury/modules/guardian"
	guardiankeeper "github.com/nimrostafarian/gridfury/modules/guardian/keeper"
	guardiantypes "github.com/nimrostafarian/gridfury/modules/guardian/types"
	"github.com/nimrostafarian/gridfury/modules/mint"
	mintkeeper "github.com/nimrostafarian/gridfury/modules/mint/keeper"
	minttypes "github.com/nimrostafarian/gridfury/modules/mint/types"
	gridtypes "github.com/nimrostafarian/gridfury/types"
)
...
func NewFuryApp(
	...
	bApp := baseapp.NewBaseApp(gridtypes.AppName, logger, db, encodingConfig.TxConfig.TxDecoder(), baseAppOptions...)
	...
	app.TokenKeeper = tokenkeeper.NewKeeper(
		...
		gridtypes.NativeToken.MinUnit: tokenv1.SwapParams{
			MinUnit: gridtypes.EvmToken.MinUnit,
			Ratio:   sdk.OneDec(),
		},
		gridtypes.EvmToken.MinUnit: tokenv1.SwapParams{
			MinUnit: gridtypes.NativeToken.MinUnit,
			Ratio:   sdk.OneDec(),
		},
	})
	...
	app.mm = module.NewManager(
		...
		gridevm.NewAppModule(app.EvmKeeper, app.AccountKeeper, app.BankKeeper),
	...
	anteHandler := gridfuryante.NewAnteHandler(
		gridfuryante.HandlerOptions{
...
func (app *FuryApp) InitChainer(ctx sdk.Context, req abci.RequestInitChain) abci.ResponseInitChain {
	var genesisState gridtypes.GenesisState
