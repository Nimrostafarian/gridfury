...
import (
	...
	migratehtlc "github.com/nimrostafarian/gridfury/migrate/htlc"
	migrateservice "github.com/nimrostafarian/gridfury/migrate/service"
	migratetibc "github.com/nimrostafarian/gridfury/migrate/tibc"
	...
	app.RegisterUpgradeHandler(
		...
		func(ctx sdk.Context, plan sdkupgrade.Plan, fromVM module.VersionMap) (module.VersionMap, error) {
			...
			tibcclienttypes.SetDefaultGenesisState(tibcclienttypes.GenesisState{
				NativeChainName: "gridfury-mainnet",
			})
