...
go mod download github.com/irisnet/irismod@${FURYMOD_VERSION}

chmod -R 755 ${GOPATH}/pkg/mod/github.com/cosmos/cosmos-sdk@${SDK_VERSION}/proto
chmod -R 755 ${GOPATH}/pkg/mod/github.com/irisnet/irismod@${FURYMOD_VERSION}/proto

cp -r ${GOPATH}/pkg/mod/github.com/cosmos/cosmos-sdk@${SDK_VERSION}/proto ./tmp && rm -rf ./tmp/proto/cosmos/mint
cp -r ${GOPATH}/pkg/mod/github.com/irisnet/irismod@${FURYMOD_VERSION}/proto ./tmp
cp -r ./proto ./tmp
...
sed -r -i 's/cosmos1[a-z,0-9]+/did:grid:iaa1sltcyjm5k0edlg59t47lsyw8gtgc3nudklntcq/g' ./lite/swagger-ui/swagger.yaml
sed -r -i 's/cosmosvaloper1[a-z,0-9]+/did:grid:did:grid:iva1sltcyjm5k0edlg59t47lsyw8gtgc3nudrwey98/g' ./lite/swagger-ui/swagger.yaml
sed -r -i 's/cosmosvalconspub1[a-z,0-9]+/did:grid:did:grid:icp1zcjduepqwhwqn4h5v6mqa7k3kmy7cjzchsx5ptsrqaulwrgfmghy3k9jtdzs6rdddm/g' ./lite/swagger-ui/swagger.yaml
sed -i 's/Gaia/FURYhub/g' ./lite/swagger-ui/swagger.yaml
sed -i 's/gaia/gridfury/g' ./lite/swagger-ui/swagger.yaml
sed -i 's/cosmoshub/gridfury/g' ./lite/swagger-ui/swagger.yaml
