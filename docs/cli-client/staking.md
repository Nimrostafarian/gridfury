...
```bash
grid tx staking create-validator --chain-id=gridfury --from=<key-name> --fees=0.3grid --pubkey=<validator-pubKey> --commission-rate=0.1 --amount=100grid --moniker=<validator-name>
```
...
```bash
grid tx staking edit-validator --from=<key-name> --chain-id=gridfury --fees=0.3grid --commission-rate=0.10 --moniker=<validator-name>
```
...
```bash
grid tx staking delegate <iva...> <amount> --chain-id=gridfury --from=<key-name> --fees=0.3grid
```
...
```bash
grid tx staking unbond <iva...> 10grid --from=<key-name> --chain-id=gridfury --fees=0.3grid
```
...
```bash
grid tx staking redelegate <iva...> <iva...> 10grid --chain-id=gridfury --from=<key-name> --fees=0.3grid
```
