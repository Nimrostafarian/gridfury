...
- name: Mykey
  type: local
  address: did:grid:iaa1tulwx2hwz4dv8te6cflhda64dn0984harlzegw
...
- name: Mykey
  type: local
  address: did:grid:iva1tulwx2hwz4dv8te6cflhda64dn0984hakwgk4f
  pubkey: did:grid:ivp1addwnpepq24rufap6u0sysqcpgsfzqhw3x8nfkhqhtmpgqt0369rlyqcg0vkgd8e6zy
  mnemonic: ""
  threshold: 0
  pubkeys: []
```
