...
FURYhub metrics also contains tendermint metrics, Visit [tendermint metrics](https://github.com/nimrostafarian/tendermint/blob/nimrostafarian/master/docs/tendermint-core/metrics.md) for more information.
