...
The gridhub versions v1.0.0 (depends on Cosmos-SDK v0.41) and earlier provided REST endpoints to query the state and broadcast transactions. These endpoints are kept in gridhub v1.0, but they are marked as deprecated, and will be removed after a few versions therefore call these endpoints legacy REST endpoints.
...
The same code as integrating with gridhub-v0.16.3 mainnet. The transaction structure is as follows:
