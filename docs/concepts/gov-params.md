...
In FURYhub, there are some special parameters that can be modified through on-chain governance.
...
| `token/IssueTokenBaseFee` | Base token for issuing tokens     | amount: (0, +∞) | {"denom": "grid","amount": "60000"} |
