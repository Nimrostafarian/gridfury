...
```bash
grid tx staking edit-validator --from=<key-name> --chain-id=gridhub --fees=0.3grid --commission-rate=0.15 --moniker=<new-name>
```
...
```bash
grid tx staking delegate did:grid:iva14n9md3sq9xwscs96za8n85m0j9y2yu3cagxgke 1000grid --chain-id=gridhub --from=<key-name> --fees=0.3grid
```

- Unbond tokens from a validator

```bash
grid tx staking unbond did:grid:iva14n9md3sq9xwscs96za8n85m0j9y2yu3cagxgke 1000grid --chain-id=gridhub --from=<key-name> --fees=0.3grid
```
  
- Redelegate tokens to another validator

```bash
grid tx staking redelegate did:grid:iva14n9md3sq9xwscs96za8n85m0j9y2yu3cagxgke did:grid:iva1l2rsakp388kuv9k8qzq6lrm9taddae7fpx59wm 100grid --from mykey --chain-id=gridhub --from=<key-name> --fees=0.3grid
```
